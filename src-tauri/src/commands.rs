pub mod commands {
    ...
    /// - 包含Android版本的字符串
    #[tauri::command]
    pub fn get_phone_android_version(id: String) -> String {
    ...
    /// - 包含Android SDK版本的字符串
    #[tauri::command]
    pub fn get_phone_android_sdk_version(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    #[tauri::command]
    pub fn get_phone_bootloader_if_start(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含内核版本的字符串
    #[tauri::command]
    pub fn get_phone_android_kernel_version(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含系统构建描述的字符串
    #[tauri::command]
    pub fn get_phone_system_build_description(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含系统构建ID的字符串
    #[tauri::command]
    pub fn get_phone_system_build_id(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含系统构建安全补丁版本的字符串
    #[tauri::command]
    pub fn get_phone_system_build_version_security(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含CPU ABI的字符串
    #[tauri::command]
    pub fn get_phone_system_cpu_abi(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含产品型号的字符串
    #[tauri::command]
    pub fn get_phone_product_model(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含内核QEMU状态的字符串
    #[tauri::command]
    pub fn get_phone_kernel_qemu(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含硬件信息的字符串
    #[tauri::command]
    pub fn get_phone_hardware(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含产品品牌的字符串
    #[tauri::command]
    pub fn get_phone_ro_product_brand(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含产品设备名称的字符串
    #[tauri::command]
    pub fn get_phone_ro_product_device(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含产品制造商的字符串
    #[tauri::command]
    pub fn get_phone_ro_product_manufacturer(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
    ...
    /// - 包含Modem软件版本的字符串
    #[tauri::command]
    pub fn get_phone_modem_software_version(id: String) -> String {
        let res = get_no_root_phone_data(str_to_cstr(id));
        unsafe {
            let data_ref = &mut *res;
